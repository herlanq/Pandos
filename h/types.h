...
#define t_recv_status       d_status /*RECVSTATUS*/
#define t_recv_command      d_command /*RECVCOMMAND*/
#define t_transm_status     d_data0 /*TRANSTATUS*/
#define t_transm_command    d_data1 /*TRANCOMMAND*/
